...
@section('page-action')
    <div>
        ...
        @permission('user import')
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-title="{{ __('Import User') }}"
                data-url="{{ route('users.file.import') }}" data-toggle="tooltip" title="{{ __('Import User') }}"><i
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    {{ Form::select('role', $roles, isset($_GET['role']) ? $_GET['role'] : '', ['class' => 'form-control select', 'placeholder' => '']) }}
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body  text-center">
                        <img src="{{ check_file($user->avatar) ? get_file($user->avatar) : get_file('uploads/users-avatar/avatar.png') }}"
                            alt="user-image" class="img-fluid rounded-circle" width="120px" style="
                            height: 120px">
