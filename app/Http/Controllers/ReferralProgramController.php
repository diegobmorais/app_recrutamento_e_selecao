...
class ReferralProgramController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $setting->percentage = !empty($request->percentage) ? $request->percentage : 0;
        $setting->minimum_threshold_amount = !empty($request->minimum_threshold_amount) ? $request->minimum_threshold_amount : 0;
        $setting->is_enable  = $is_enable;
        $setting->guideline = !empty($request->guideline) ? $request->guideline : 0;
