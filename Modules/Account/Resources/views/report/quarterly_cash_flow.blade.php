                            ...
                            <div class="col-xl-9">
                                <div class="row justify-content-end align-items-center">
                                    ...
                                    <div class="col-auto mt-4">
                                        <a class="btn btn-sm btn-primary" onclick="document.getElementById('quarterly_cashflow').submit(); return false;" data-bs-toggle="tooltip" title="{{__('Apply')}}" data-original-title="{{__('apply')}}">
