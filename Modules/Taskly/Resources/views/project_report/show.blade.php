             ...
             <div class="monthly_cashflow">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="GET" action="{{route('project_report.show',$project->id)}}" accept-charset="UTF-8" id="monthly_cashflow">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="row justify-content-between">
                                            <div class="col-xl-3">
                                                <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#daily-chart" role="tab" aria-controls="pills-home" aria-selected="true">{{__('Monthly')}}</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link quarterly" id="pills-profile-tab" data-bs-toggle="pill" href="#"  role="tab" aria-controls="pills-profile" aria-selected="true">{{__('Quarterly')}}</a>
                                                    </li>
                                            ...
                                            <div class="col-xl-9">
                                                <div class="row justify-content-end align-items-center">
                                                    ...
                                                    <div class="col-auto mt-4">
                                                        <a href="#" class="btn btn-sm btn-primary" onclick="document.getElementById('monthly_cashflow').submit(); return false;" data-bs-toggle="tooltip" title="" data-original-title="apply" data-bs-original-title="Apply">
                                                            <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                                                        </a>
                                                        <a href="https://demo.workdo.io/accountgo/reports-monthly-cashflow" class="btn btn-sm btn-danger " data-bs-toggle="tooltip" title="" data-original-title="Reset" data-bs-original-title="Reset">
                                                            <span class="btn-inner--icon"><i class="ti ti-trash-off text-white-off "></i></span>
                                                        </a>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="table-responsive mt-3 mb-3">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td width="20%" class="text-dark">{{__('Total Income (Invoice)')}}</td>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="table-responsive mt-4">
                                                    <table class="table mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="20%" class="text-dark">{{__('Total Expenses (Bill)')}}</td>
