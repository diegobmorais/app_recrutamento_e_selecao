...
@section('page-action')
    <div>
        ...
        @endpermission
        <a href="{{ route('projects.calendar', [$project->id]) }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
            data-bs-original-title="{{ __('Calendar View') }}">
            <i class="ti ti-calendar"></i>
        </a>
        <a href="{{ route('projects.gantt', [$project->id]) }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
