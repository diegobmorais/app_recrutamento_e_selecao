                                            ...
                                            @if ($project->is_active)
                                                <a href="@permission('project manage') {{ route('projects.show', [$project->id]) }} @endpermission"
                                                    title="{{ $project->name }}" class="">{{ $project->name }}<i
                                                        class="px-2 ti ti-eye" data-toggle="tooltip"
                                                        title="{{ __('view') }}"></i></a>
                                            @else
                                    ...
                                    <div class="row g-2 justify-content-between">
                                        ...
                                        <div class="col-auto">
                                            <a href= {{ route('projects.show', [$project->id]) }}>
                                                <i class="ti ti-eye" data-toggle="tooltip" title="" data-bs-original-title="view" aria-label="view"></i>
                                            </a>
                                            <a href= {{ route('projects.task.board', [$project->id]) }}>
                                                <i class="ti ti-file-text" data-toggle="tooltip" title="" data-bs-original-title="Task Board" aria-label="Task Board"></i>
                                            </a>
                                        </div>
