...
@section('page-action')
    ...
    @permission('project setting')
        @php
            $title = module_is_active('ProjectTemplate') && $project->type == 'template' ? __('Shared Project Template Settings') : __('Shared Project Settings')
        @endphp
        <div class="col-sm-auto">
            <a href="#" class="btn btn-xs btn-primary btn-icon-only col-12"
                data-title="{{ $title }}" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip"
    ...
    @permission('task manage')
        <div class="col-sm-auto">
            <a href="{{ route('projects.calendar', [$project->id]) }}"
                class="btn btn-xs btn-primary btn-icon-only width-auto ">{{ __('Calendar') }}</a>
        </div>
    @endpermission
    <div class="col-sm-auto">
    ...
    @permission('project finance manage')
            ...
            <div class="col-sm-auto">
                <a href="{{ route('projects.proposal', [$project->id]) }}"
                    class="btn btn-xs btn-primary btn-icon-only width-auto ">{{ __('Finance') }}</a>
            </div>
    @endpermission
    @if (module_is_active('Procurement'))
    <div class="col-sm-auto">
        <a href="{{ route('rfx.index') }}"
            class="btn btn-xs btn-primary btn-icon-only width-auto ">{{ __('RFx') }}</a>
    </div>
    @endif
