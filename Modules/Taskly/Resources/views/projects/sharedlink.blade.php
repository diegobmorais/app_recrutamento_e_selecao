                ...
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    @if (module_is_active('Procurement'))
                        @if (isset($setting->procurement) && $setting->procurement == 'on')
                            <a href="#tabs-14" class="list-group-item list-group-item-action border-0">{{ __('Procurement') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                        @endif
                    @endif
                                                            ...
                                                            <td class="Id">
                                                                @permission('bill show')
                                                                    <a target="_new"
                                                                        ...
                                                                        class="btn btn-outline-primary">{{ Modules\Account\Entities\Bill::billNumberFormat($bill->bill_id, $bill->created_by, $bill->workspace) }}</a>
                                                                @else
                                                                    <a
                                                                        class="btn btn-outline-primary">{{ Modules\Account\Entities\Bill::billNumberFormat($bill->bill_id, $bill->created_by, $bill->workspace) }}</a>
                                                        @endif
                                                    ...
                                                    <tr class="font-style">
                                                        <td class="Id">
                                                            <a href="{{ route('pay.retainer', \Crypt::encrypt($retainer->id)) }}"
                                                                class="btn btn-outline-primary">{{ Modules\Retainer\Entities\Retainer::retainerNumberFormat($retainer->retainer_id ,$retainer->created_by ,$retainer->workspace ) }}
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td>{{ company_date_formate($retainer->issue_date, $retainer->created_by ,$retainer->workspace) }}</td>
                                                        <td>{{ currency_format_with_sym($retainer->getDue() ,$retainer->created_by ,$retainer->workspace) }}</td>
                                                        <td>
                                                            @if ($retainer->status == 0)
                                                                <span
                                                                    class="badge fix_badges bg-primary p-2 px-3 rounded">{{ __(Modules\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 1)
                                                                <span
                                                                    class="badge fix_badges bg-info p-2 px-3 rounded">{{ __(Modules\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 2)
                                                                <span
                                                                    class="badge fix_badges bg-secondary p-2 px-3 rounded">{{ __(Modules\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 3)
                                                                <span
                                                                    class="badge fix_badges bg-warning p-2 px-3 rounded">{{ __(Modules\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 4)
                                                                <span
                                                                    class="badge fix_badges bg-danger p-2 px-3 rounded">{{ __(Modules\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
