...
Route::group(['middleware' => 'PlanModuleCheck:Taskly'], function ()
{
    ...
    Route::get('projects/{id}/calendar',[ProjectController::class,'calendar'])->name('projects.calendar')->middleware(['auth']);
    ...
    Route::post('projects/task-member/{id}/{cid?}', [ProjectController::class,'TaskMember'])->name('tasks.members')->middleware(['auth']);
    ...
    // finance page
    Route::get('projects/{id}/proposal',[ProjectController::class,'proposal'])->name('projects.proposal')->middleware(['auth']);
    Route::get('projects/{id}/invoice',[ProjectController::class,'invoice'])->name('projects.invoice')->middleware(['auth']);
    ...
    Route::post('reports-quarterly-cashflow/{id}', [ProjectReportController::class, 'quarterlyCashflow'])->name('projectreport.quarterly.cashflow')->middleware(['auth']);
