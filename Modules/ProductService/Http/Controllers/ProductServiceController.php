...
use Modules\ConsignmentManagement\Entities\ConsignmentWeight;
...
use Modules\Facilities\Entities\FacilitiesSpace;
...
class ProductServiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (Auth::user()->isAbleTo('product&service manage')) {
            ...
            if(module_is_active('Facilities')) {
                $product_type['facilities'] = 'Faciliies';
            }
    ...
    public function ProductSectionGet(Request $request)
    {
        ...
        elseif($type == 'service' || $type == 'rent' || $type == 'music institute' || $type == 'fleet' )
        {
            ...
            $returnHTML = view('consignmentmanagement::item.section', compact('category', 'type', 'unit', 'tax', 'customFields', 'productService', 'action', 'weight','warehouse'))->render();
            $response = [
                'is_success' => true,
                'message' => '',
                'html' => $returnHTML,
