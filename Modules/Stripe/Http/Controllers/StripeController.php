...
use Modules\EventsManagement\Entities\EventsMange;
use Modules\EventsManagement\Entities\EventsBookings;
use Modules\EventsManagement\Entities\EventBookingOrder;
...
use Modules\Facilities\Entities\FacilitiesService;
use Modules\Facilities\Entities\FacilitiesBooking;
use Modules\Facilities\Entities\FacilitiesReceipt;
use Modules\PropertyManagement\Entities\Property;
use Modules\PropertyManagement\Entities\PropertyTenantRequest;
use Modules\VehicleBookingManagement\Entities\Booking;
use Modules\VehicleBookingManagement\Entities\VehicleBookingPayments;
...
class StripeController extends Controller
{
    ...
    public function EventShowBookingPayWithStripe(Request $request, $slug, $lang = '')
    {
        ...
        if ($event) {
            ...
            return view('eventsmanagement::booking.stripe', compact('stripe_session', 'event'));
        } else {
    ...
    public function PropertyBookingPayWithStripe(Request $request, $slug)
    {
        ...
        if ($property)
        {
            ...
            return view('propertymanagement::frontend.stripe', compact('stripe_session', 'property'));
        }
        else {
            $msg = __('Event is deleted.');
            return redirect()->back()->with('msg', $msg);
